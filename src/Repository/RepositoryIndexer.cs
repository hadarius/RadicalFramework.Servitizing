...
public partial class Repository<TEntity>
{
    ...
    public virtual TEntity this[bool reverse, EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual object this[bool reverse, Expression<Func<TEntity, object>> selector, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
    ...
    public virtual TEntity this[bool reverse, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual TEntity this[bool reverse, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
        => (reverse) ? this[predicate, sortTerms, expanders].LastOrDefault() : this[predicate, sortTerms, expanders].FirstOrDefault();

    public virtual TEntity this[bool reverse, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
    ...
    public virtual ISeries<TEntity> this[int skip, int take, EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual IList<object> this[int skip, int take, Expression<Func<TEntity, object>> selector, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
    ...
    public virtual ISeries<TEntity> this[int skip, int take, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual ISeries<TEntity> this[int skip, int take, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
        => (take > 0) ? this[predicate, sortTerms, expanders].Skip(skip).Take(take).ToRegistry() : this[predicate, sortTerms, expanders].ToRegistry();

    public virtual ISeries<TEntity> this[int skip, int take, EntitySortExpression<TEntity> sortTerms, Expression<Func<TEntity, object>>[] expanders]
    ...
    public virtual IQueryable<TEntity> this[EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual IQueryable<object> this[Expression<Func<TEntity, object>> selector, Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
    ...
    public virtual IQueryable<TEntity> this[Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms]
    ...
    public virtual IQueryable<TEntity> this[EntitySortExpression<TEntity> sortTerms, Expression<Func<TEntity, object>>[] expanders]
        => Sort(this[expanders], sortTerms);
    public virtual IQueryable<TEntity> this[Expression<Func<TEntity, bool>> predicate, EntitySortExpression<TEntity> sortTerms, params Expression<Func<TEntity, object>>[] expanders]
