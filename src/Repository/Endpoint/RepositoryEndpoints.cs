...
{
    public class RepositoryEndpoints : Registry<IRepositoryEndpoint>, IRepositoryEndpoints
    {
        ...
        public IRepositoryEndpoint<TContext> New<TContext>(DbContextOptions<TContext> options) where TContext : DataStoreContext
        {
