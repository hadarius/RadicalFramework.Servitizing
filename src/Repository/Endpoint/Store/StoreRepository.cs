...
public partial class StoreRepository<TEntity> : Repository<TEntity>, IStoreRepository<TEntity>
    where TEntity : class, IUniqueIdentifiable, IEntity
{
    DbSet<TEntity> _dbSet;

    public StoreRepository() : base() { }

    public StoreRepository(IRepositoryEndpoint repositorySource) : base(repositorySource)
    {
        TrackingEvents();
    }
    ...
    where TStore : IStore
{
    public StoreRepository(
        ...
        ILinkedSynchronizer synchronizer
